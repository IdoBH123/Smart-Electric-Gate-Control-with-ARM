...
#define PERSON_SHOW         1       // Pin for opening the gate
...
// For 1ms pulse (0 degrees) = 39M * 1.03ms ≈ 40000 (Pulse Width = x/Clock Frequency)
#define SERVO_CLOSED   40000    // 1.03ms pulse for 0 degrees
